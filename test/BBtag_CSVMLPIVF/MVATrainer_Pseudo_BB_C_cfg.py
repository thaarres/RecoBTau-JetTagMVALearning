...
process.CombinedSVV2Trainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	ignoreFlavours		= cms.vint32(0, 1, 2, 3, 5, 21),
	...
	fileNames = cms.vstring(
		...
		" /shome/thaarres/BBRetraining_SignalRadion_BackgroundQCD/skimmed_20k_eachptetabin_CombinedSVV2PseudoVertex_C.root"
	),
)
...
process.looper = cms.Looper("JetTagMVATrainerLooper",
	trainers = cms.VPSet(
		cms.PSet(
			calibrationRecord = cms.string("CombinedSVV2PseudoVertex"),
			trainDescription = cms.untracked.string("Save_Pseudo_BB_C.xml"),
