...
process.CombinedSVV2Trainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		...
		" /shome/thaarres/BBRetraining_SignalRadion_BackgroundQCD/skimmed_20k_eachptetabin_CombinedSVV2RecoVertex_B.root"
	)
)
...
process.looper = cms.Looper("JetTagMVATrainerLooper",
	trainers = cms.VPSet(
		cms.PSet(
			calibrationRecord = cms.string("CombinedSVV2RecoVertex"),
			trainDescription = cms.untracked.string("Save_Reco_BB_B.xml"),
