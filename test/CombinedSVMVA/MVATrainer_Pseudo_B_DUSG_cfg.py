...
process.combinedSVTrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	factor = cms.double(500),
	bound = cms.double(500),

	fileNames = cms.vstring(
		"/store/mrg/CombinedSVPseudoVertex_B.root",
		"/store/mrg/CombinedSVPseudoVertex_DUSG.root"
	),
	weightFile = cms.string("weights/CombinedSVPseudoVertex_BL_histo.txt"),
