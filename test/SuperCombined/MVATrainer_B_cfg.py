...
process.combinedMVATrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		"/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/DEVELOPMENT/SuperTaggerDev/CMSSW_5_3_14/src/CrabJobs/TTJets_inclusive_SC_CSVSL/TTJetsIncl/combinedMVA_B.root",
	)
)
