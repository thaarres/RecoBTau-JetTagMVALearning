...
//		if((*algoDiscriminator)[2] < 9999. && (*algoDiscriminator)[3] < 9999. && (*algoDiscriminator)[2] > -0.5 && (*algoDiscriminator)[3] > -0.5)					
	...
	cout << "Correlation between JP and CSV: " <<correlationJPCSV << endl;
	cout << "Correlation between JP and SM: " <<correlationJPSM << endl;
	cout << "Correlation between JP and SE: " <<correlationJPSE << endl;
	cout << "Correlation between CSV and SM: " <<correlationCSVSM << endl;
	cout << "Correlation between CSV and SE: " <<correlationCSVSE << endl;
	cout << "Correlation between SM and SE: " <<correlationSMSE << endl;
...
DiscriminatorSE_DUSG->GetXaxis()->SetRangeUser(0,1);
