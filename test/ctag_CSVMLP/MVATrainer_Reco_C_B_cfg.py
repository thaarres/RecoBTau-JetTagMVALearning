...
process.CombinedSVV2Trainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	weightFile = cms.string("weights/CombinedSVV2RecoVertex_CB_histo.txt"),
	biasFiles = cms.vstring(
		"-",
		"*",
		"weights/CombinedSVV2RecoVertex_C_B_ratio.txt"
	)
)
...
process.looper = cms.Looper("JetTagMVATrainerLooper",
	trainers = cms.VPSet(
		cms.PSet(
			calibrationRecord = cms.string("CombinedSVV2RecoVertex"),
			trainDescription = cms.untracked.string("Save_Reco_C_B.xml"),
