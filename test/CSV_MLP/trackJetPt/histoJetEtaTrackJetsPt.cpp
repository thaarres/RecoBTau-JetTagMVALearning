...
void paint(TString dir, TString a, TString b)
{
	...
	TH2D * histo = new TH2D("jets", "jets", 50, -2.5, 2.5, 40, 0.0001, 6.95654544315);//pt starting from 15 and until 1000
	...
	t->Draw("log(trackJetPt+50):jetEta >> +jets", "", "Lego goff");

	TH2D * histo_lin = new TH2D("jets_lin", "jets_lin", 50, -2.5, 2.5, 40, 0, 1000);//pt starting from 15 and until 1000
	t->Draw("trackJetPt:jetEta >> +jets_lin", "", "Lego goff");
...
int main(int argc, char **argv)
{
	TString dir = "";
	TString fix = "";
	if(argc == 2 || argc == 3) dir = TString(argv[1])+"skimmed_20k_eachtrackjetptetabin_";
