...
# CSVV1: LR-based
process.combinedSecondaryVertexV1.calibrationRecords = cms.vstring(
...
process.combinedSecondaryVertexIVFV1BJetTags = process.combinedSecondaryVertexV1BJetTags.clone(
	jetTagComputer = cms.string('combinedSecondaryVertexIVFV1'),
	tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfos"),
	                         cms.InputTag("inclusiveSecondaryVertexFinderTagInfos")) #inclusiveSecondaryVertexFinderFilteredTagInfos
)
...
#* process.combinedSecondaryVertexIVFV1BJetTags 
* process.combinedSecondaryVertexIVFV2BJetTags 
#* process.combinedSecondaryVertexSoftLeptonIVFBJetTags
)

# CSVIVFV2ctag: MLP-based
process.combinedSecondaryVertexIVFV2ctag=process.combinedSecondaryVertexV2.clone(
	calibrationRecords = cms.vstring(
...
process.combinedSecondaryVertexIVFV2CJetTags = process.combinedSecondaryVertexV2BJetTags.clone(
	jetTagComputer = cms.string('combinedSecondaryVertexIVFV2ctag'),
	tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfos"),
	                         cms.InputTag("inclusiveSecondaryVertexFinderTagInfos")) #inclusiveSecondaryVertexFinderFilteredTagInfos
)
process.combinedSecondaryVertexIVFV2ctag.trackSelection.qualityClass = cms.string('any')
process.combinedSecondaryVertexIVFV2ctag.trackPseudoSelection.qualityClass = cms.string('any')
process.combinedSecondaryVertexIVFV2ctag.trackMultiplicityMin = cms.uint32(2)

# CSVSLIVFctag: CSVSL+IVF
process.combinedSecondaryVertexSoftLeptonIVFctag=process.combinedSecondaryVertexSoftLepton.clone(
	calibrationRecords = cms.vstring(
...
process.combinedSecondaryVertexSoftLeptonIVFCJetTags = process.combinedSecondaryVertexSoftLeptonBJetTags.clone(
	jetTagComputer = cms.string('combinedSecondaryVertexSoftLeptonIVFctag'),
	tagInfos = cms.VInputTag(cms.InputTag("impactParameterTagInfos"),
	                         cms.InputTag("inclusiveSecondaryVertexFinderTagInfos"),#inclusiveSecondaryVertexFinderFilteredTagInfos
													 cms.InputTag("softPFMuonsTagInfos"),
													 cms.InputTag("softPFElectronsTagInfos"))
)
process.combinedSecondaryVertexSoftLeptonIVFctag.trackSelection.qualityClass = cms.string('any')
process.combinedSecondaryVertexSoftLeptonIVFctag.trackPseudoSelection.qualityClass = cms.string('any')
process.combinedSecondaryVertexSoftLeptonIVFctag.trackMultiplicityMin = cms.uint32(2)


process.CombinedIVFctaggers = cms.Sequence(
#process.combinedSecondaryVertexIVFV2CJetTags *
process.combinedSecondaryVertexSoftLeptonIVFCJetTags
)
...
#        			startEffPur = cms.double(-0.005)
#    				),
#            label = cms.InputTag("combinedSecondaryVertexIVFV2CJetTags"),
...
#        ), 
            ...
            label = cms.InputTag("combinedSecondaryVertexSoftLeptonIVFCJetTags"),
            folder = cms.string("CSVIVFSLctag") 
        ) 
			),
      finalizePlots = False,
      finalizeOnly = False
