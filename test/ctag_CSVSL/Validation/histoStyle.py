...
ValRel = "612SLHC2_14testC"
RefRel = "612SLHC1_14testC"
...
class plotInfo :
    def __init__ (self, name, title, #mandatory
        ...
        if self.doPerformance : 
            ...
            self.name = name.replace("TAG",tagFlavor)
