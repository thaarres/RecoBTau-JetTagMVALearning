...
process.combinedSVTrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		...
		"/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/DEVELOPMENT/RootFiles_CSVSLIVF_JetFlavourPUjetIDcleanIVF/QCD_training/skimmed_20k_eachptetabin_CombinedSVPseudoVertexSoftElectron_B.root"
	),
	weightFile = cms.string("weights/CombinedSVPseudoVertexSoftElectron_CB_histo.txt"),
	biasFiles = cms.vstring(
		"*",
		"-",
		"weights/CombinedSVPseudoVertexSoftElectron_C_B_ratio.txt"
	)
)
...
process.looper = cms.Looper("JetTagMVATrainerLooper",
	trainers = cms.VPSet(
		cms.PSet(
			calibrationRecord = cms.string("CombinedSVPseudoVertexSoftElectron"),
			trainDescription = cms.untracked.string("Save_PseudoVertexSoftElectron_C_B.xml"),
