...
process.BTauMVAJetTagComputerRecord = cms.ESSource("PoolDBESSource",
	...
	connect = cms.string("sqlite_file:CompareAllTaggers_MVAJetTags.db"),
...
# Adding My Tagger CSVIVFV2: MLP-based
...
# combined IP+IVF or IP+IVF+SL taggers, adding my tagger
...
process.CustombTagValidation = process.bTagValidation.clone(
    tagConfig = cms.VPSet(
        ...
        cms.PSet(
           ...
           folder = cms.string("CSVIVFV2NEW") # My MLP+IVF-based CSVIVFV2NEW!
       ),
			),
      finalizePlots = False,
      finalizeOnly = False
