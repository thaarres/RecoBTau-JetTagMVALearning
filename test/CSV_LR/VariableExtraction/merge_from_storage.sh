...
maindirec=/pnfs/iihe/cms/store/user/`whoami`/BtagExtractor_53X/PFnoPU_highPT/
...
homedirec=/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/CMSSW_5_3_4_patch1/src/RootFiles_QCDhighpT_53X

CAT=(CombinedSVRecoVertex CombinedSVPseudoVertex CombinedSVNoVertex)
FLAV=(B C DUSG)
CAT=( CombinedSVNoVertex)
FLAV=(DUSG)
