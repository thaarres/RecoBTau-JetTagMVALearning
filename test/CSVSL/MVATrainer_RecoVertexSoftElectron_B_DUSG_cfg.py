...
process.combinedSVTrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		...
		"/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/DEVELOPMENT/SuperTaggerDev/CMSSW_5_3_14/src/RootFiles/SkimmedRootFiles/skimmed_max20k_eachptetabin_CombinedSVRecoVertexSoftElectron_DUSG.root"
	),
	weightFile = cms.string("weights/CombinedSVRecoVertexSoftElectron_BDUSG_histo.txt"),
	biasFiles = cms.vstring(
		"*",
		"-",
		"weights/CombinedSVRecoVertexSoftElectron_B_DUSG_ratio.txt"
	)
)
...
process.looper = cms.Looper("JetTagMVATrainerLooper",
	trainers = cms.VPSet(
		cms.PSet(
			calibrationRecord = cms.string("CombinedSVRecoVertexSoftElectron"),
			trainDescription = cms.untracked.string("Save_RecoVertexSoftElectron_B_DUSG.xml"),
