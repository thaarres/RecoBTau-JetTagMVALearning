...
process.combinedSVTrainer = cms.EDAnalyzer("JetTagMVATreeTrainer",
	...
	fileNames = cms.vstring(
		...
		"/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/DEVELOPMENT/SuperTaggerDev/CMSSW_5_3_14/src/RootFiles/SkimmedRootFiles/skimmed_max20k_eachptetabin_CombinedSVRecoVertexNoSoftLepton_C.root"
	),
	weightFile = cms.string("weights/CombinedSVRecoVertexNoSoftLepton_BC_histo.txt"),
	biasFiles = cms.vstring(
		"*",
		"-",
		"weights/CombinedSVRecoVertexNoSoftLepton_B_C_ratio.txt"
	)
)
...
process.looper = cms.Looper("JetTagMVATrainerLooper",
	trainers = cms.VPSet(
		cms.PSet(
			calibrationRecord = cms.string("CombinedSVRecoVertexNoSoftLepton"),
			trainDescription = cms.untracked.string("Save_RecoVertexNoSoftLepton_B_C.xml"),
