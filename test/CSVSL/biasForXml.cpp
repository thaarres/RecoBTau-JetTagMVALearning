...
int main(int argc, char **argv){
	string dir = "/user/pvmulder/NewEraOfDataAnalysis/BTagServiceWork/DEVELOPMENT/SuperTaggerDev/CMSSW_5_3_14/src//RootFiles/TT_inclDuplGone";
	...
	cout << "for jet flavour B there are " << entries[0][0]+entries[3][0]+entries[6][0]+entries[9][0]+entries[12][0]+entries[15][0]+entries[18][0]+entries[21][0]+entries[24][0]<< " entries"  << endl;
	cout << "for jet flavour C there are " << entries[1][0]+entries[4][0]+entries[7][0]+entries[10][0]+entries[13][0]+entries[16][0]+entries[19][0]+entries[22][0]+entries[25][0] << " entries"  << endl;
