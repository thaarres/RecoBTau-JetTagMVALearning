...
*/
  ...
  const int nCalibRecords = 17;
  std::string calibRecords[nCalibRecords] = {"CombinedSVRecoVertexNoSoftLepton","CombinedSVRecoVertexSoftElectron","CombinedSVRecoVertexSoftMuon","CombinedSVPseudoVertexNoSoftLepton","CombinedSVPseudoVertexSoftElectron","CombinedSVPseudoVertexSoftMuon","CombinedSVNoVertexNoSoftLepton","CombinedSVNoVertexSoftElectron","CombinedSVNoVertexSoftMuon", "CombinedSVNoVertex","CombinedSVPseudoVertex","CombinedSVRecoVertex", "CombinedSVV2NoVertex","CombinedSVV2PseudoVertex","CombinedSVV2RecoVertex", "CombinedSVV2RecoRecoVertex", "combinedMVA"};
  bool calibRecordFound = false;
  for(int i=0; i<nCalibRecords; i++){ 
